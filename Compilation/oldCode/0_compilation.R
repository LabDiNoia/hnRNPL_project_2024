...
#cur_SE_dt<-uniqSig_SE[commonID=="35622"]
#cur_SE_dt<-uniqSig_SE[commonID=="37776"] #sirt1
#cur_SE_dt<-uniqSig_SE[commonID=="44864"] #ubap2l
#cur_SE_dt<-uniqSig_SE[commonID=="36496"] #gpbp1
...
saveRDS(commonSpliceID_lookup_dt,"commonSpliceID_lookup_dt.rds")
commonSpliceID_lookup_dt<-readRDS("commonSpliceID_lookup_dt.rds")
