...
# Genome
echo "Enter genome to align to (mm10/hg38):"
read GENOME
case $GENOME in
	mm10 )
...
# sjdbOverhang
echo "Enter sjdbOverhang value to use for STAR alignment to $GENOME genome (99 or 149):"
read SJDB_OVHG_VAL
case $SJDB_OVHG_VAL in
	149 | 99 )
		echo "The chosen sjdbOverhang value is: "$SJDB_OVHG_VAL
		#export SJDB_OVHG_VAL
		;;
	*)
		echo "Enter valid option. Not proceeding with alignments."
		exit 1
...
# for DIR in FILT_FASTQ_REL_DIR ALIGNED_BAM_REL_DIR INTERMED_FILES_REL_DIR FILT_BAM_REL_DIR PEAKS_REL_DIR
